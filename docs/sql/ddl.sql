-- Generated 2023-10-18 09:11:34-0500 for database version 1
...
CREATE VIEW `user_score` AS SELECT s.player_id, u.display_name, s.value, s.rows_removed, s.created  FROM user AS u JOIN score AS s ON u.user_id = s.player_id ORDER BY value DESC;