-- Generated 2023-10-16 15:50:26-0500 for database version 1
...
CREATE TABLE IF NOT EXISTS `score` (`score_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `created` INTEGER NOT NULL, `started` INTEGER NOT NULL, `duration` INTEGER NOT NULL, `value` INTEGER NOT NULL, `rowsRemoved` INTEGER NOT NULL, `player_id` INTEGER NOT NULL, FOREIGN KEY(`player_id`) REFERENCES `user`(`user_id`) ON UPDATE NO ACTION ON DELETE CASCADE );
