...
public class PlayingFieldView extends GridView {
  ...
  ImageView view = (ImageView) ((convertView != null) ? convertView : inflater.inflate(R.layout.item_playing_field, parent, false));
  view.getDrawable().setLevel(0);
 // view.getDrawable().setLevel((shapeType == null) ? shapeType.values().length : shapeType.ordinal());
      return view;
    }
