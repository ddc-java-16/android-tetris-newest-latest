...
public class Block implements Cloneable{
  ...
  private boolean canMove( int rowOffset, int columnOffset, Extent extent) {
    boolean canMove = true;
    int testTopRow = topRow + rowOffset;
    int testLeftColumn = leftColumn + columnOffset;
    ...
    for (int rowIndex = 0; rowIndex < size; rowIndex++) {
      ...
      for (int colIndex = 0; colIndex < size; colIndex++) {
        int fieldColIndex = colIndex + testLeftColumn;
        if (extent.isOccupied(rowIndex, colIndex)
            && (field.isOutOfBounds(fieldRowIndex, fieldColIndex) || field.isOccupied(fieldRowIndex,
            fieldColIndex))) {
          canMove = false;
          break rowLoop;
        }
  ...
  public enum Orientation {
    ...
    private List<Kick> getKicks(ShapeType type, boolean clockwise) {
      return clockwise
          ?  clockwiseKicks.get(type) : counterclockwiseKicks.get(type);
    }
  ...
  public boolean isOccupied(int topRowIndex, int colIndex) {
    return extent.isOccupied(topRowIndex, colIndex);
  }
  ...
  private static class Extent {
    ...
    public int lastOccupiedRow() {
      int rowIndex;
      for (rowIndex = contents.length - 1; rowIndex >= 0 && isEmpty(rowIndex); rowIndex--) {
  ...
  private record Kick(int rowOffset, int columnOffset) {
     static final List<Kick> OTHER_NORTH_CW = List.of(new Kick (0, 0), new Kick (0, -1), new Kick (-1, -1), new Kick (2, 0), new Kick (2, -1));
     static final List<Kick> OTHER_EAST_EITHER = List.of(new Kick (0, 0), new Kick (0, 1), new Kick (1, 1), new Kick (-2, 0), new Kick (-2, 1));
     static final List<Kick> OTHER_SOUTH_CCW	 = List.of(new Kick (0, 0), new Kick (0, -1), new Kick (-1, -1), new Kick (2, 0), new Kick (2, -1));
     static final List<Kick> OTHER_SOUTH_CW	 = List.of(new Kick (0, 0), new Kick (0, 1), new Kick (-1, 1), new Kick (2, 0), new Kick (2, 1));
     static final List<Kick> OTHER_WEST_EITHER  = List.of(new Kick (0, 0), new Kick (0, -1), new Kick (1, -1), new Kick (-2, 0), new Kick (-2, -1));
     static final List<Kick> OTHER_NORTH_CCW = List.of(new Kick (0, 0), new Kick (0, 1), new Kick (-1, 1), new Kick (2, 0), new Kick (2, 1));

     static final List<Kick> I_NORTH_CW = List.of(new Kick(0,  0), new Kick(0, -2), new Kick(0, 1), new Kick(1, -2), new Kick(-2, 1));
     static final List<Kick> I_EAST_CCW = List.of(new Kick(0,  0), new Kick(0, 2), new Kick(0, -1), new Kick(-1, 2), new Kick(2, -1));
     static final List<Kick> I_EAST_CW = List.of(new Kick(0,  0), new Kick(0, -1), new Kick(0, 2), new Kick(-2, -1), new Kick(1, 2));
     static final List<Kick> I_SOUTH_CCW = List.of(new Kick(0,  0), new Kick(0, 1), new Kick(0, -2), new Kick(2, 1), new Kick(-1, -2));
     static final List<Kick> I_SOUTH_CW = List.of(new Kick(0,  0), new Kick(0, 2), new Kick(0, -1), new Kick(-1, 2), new Kick(2, -1));
     static final List<Kick> I_WEST_CCW = List.of(new Kick(0,  0), new Kick(0, -2), new Kick(0, 1), new Kick(1, -2), new Kick(-2, 1));
     static final List<Kick> I_WEST_CW = List.of(new Kick(0,  0), new Kick(0, 1), new Kick(0, -2), new Kick(2, 1), new Kick(-1, -2));
     static final List<Kick> I_NORTH_CCW = List.of(new Kick(0,  0), new Kick(0, -1), new Kick(0, 2), new Kick(-2, -1), new Kick(1, 2));
